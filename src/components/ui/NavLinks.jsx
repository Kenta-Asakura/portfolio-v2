...
function NavLinks({ handleNavClick }) {
  ...
  return (
    <ul className="flex flex-col gap-1.5 lg:mb-auto">
      {NAV_LINKS.map((link) => {
        ...
        return (
          <li key={link.name}>
            <a
              ...
              className={`text-base-content/80 font-secondary hover:bg-base-100 hover:text-primary focus:ring-primary flex items-center rounded-lg py-1 text-lg font-normal uppercase transition-all hover:translate-x-1 focus:ring-2 focus:outline-none lg:text-base ${
                isActive ? 'text-primary bg-base-100 translate-x-1.5' : 'text-base-content'
              }`}
