<div className="flex flex-col items-center space-y-3">
  ...
  >
    ...
    {/* Social Links Icon */}
    <svg
      className="d-swap-off mx-auto h-6 w-6 transition-transform"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  <button
    ...
    className="bg-primary hover:bg-primary/90 text-primary-content focus:ring-primary mx-auto flex items-center justify-center rounded-full p-3 transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
